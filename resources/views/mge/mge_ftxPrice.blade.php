...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">
                    FTX現貨報價 &nbsp; &nbsp;
                  <button type="button" class="btn btn-warning waves-effect waves-light" onclick="window.location='{{ url('mge/ftxPrice/update') }}'"><i class="fas fa-sync"></i> 立即更新</button>
            </h4>
        </div>
    </div>
</div>     
            ...
            <div class="card-body">
                ...
                <div class="row mb-2">
                    <div class="col-lg-12">
                        ...
                        <form class="row g-3" role="form" method="POST" enctype="multipart/form-data" action="{{ url('mge/ftxPrice') }}">
                            @csrf
